...
/*
                        Call aCall = new Call();
                        aCall.setCallerName("Ongoing outgoing call");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.ONGOING_OUTGOING_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
                        aCall.setCallerName("Ongoing incoming call");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.ONGOING_INCOMING_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
                        aCall.setCallerName("Incoming call");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.INCOMING_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
                        aCall.setCallerName("Outgoing call");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.OUTGOING_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
                        aCall.setCallerName("Missed call");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.MISSED_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
                        aCall.setCallerName("Rejected call");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.REJECTED_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
                        aCall.setCallerName(null);
                        aCall.setCallerNumber("+49800123456");
                        aCall.setDate(new Date());
                        aCall.setType(CallType.INCOMING_CALL);
                        CallLogWidget.s_CallLog.add(aCall);
                        aCall = new Call();
